...
public class C05_Faker extends TestBase {
    /*
                               - FAKER -
    ...
    public void test01() {
        ...
        firstName.sendKeys(faker.name().firstName(), Keys.TAB, faker.name().lastName(), Keys.TAB,
                faker.internet().emailAddress(), Keys.TAB, Keys.ARROW_RIGHT, Keys.TAB, faker.phoneNumber().cellPhone(), Keys.TAB, "20 Jul 2022", Keys.ENTER,
        ...
        String ortakYol = "\\Desktop\\image.png";
        String dosyaYolu = path + ortakYol;
        chooseFile.sendKeys(dosyaYolu);

        WebElement adress = driver.findElement(By.xpath("//*[@id='currentAddress']"));
        adress.sendKeys(faker.address().fullAddress(), Keys.TAB, "NCR", Keys.ENTER, Keys.TAB, "Delhi", Keys.ENTER);
        waitFor(2);
    }
}
