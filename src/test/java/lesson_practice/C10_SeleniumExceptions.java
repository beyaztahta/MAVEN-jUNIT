...
public class C10_SeleniumExceptions extends TestBase {
      /*
    ...
    public void test01() {
        ...
        List<WebElement>urunler=driver.findElements(By.partialLinkText("Apple iPhone"));//text icinde Appleİphone yazanları aldık sadece
        for (int i = 0; i < urunler.size() ; i++) {
            urunler=driver.findElements(By.partialLinkText("Apple iPhone"));
            urunler.get(i).click();
            driver.navigate().back();
        }
        //STALE_ELEMENT_REFERANCE_EXCEPTION: hatasını handle etmek icin for loop icine olusturmus oldugumuz listi koymalıyız.
